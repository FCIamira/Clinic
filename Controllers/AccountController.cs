...
namespace Clinic.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(UserManager<AplicationUser> userManager, IConfiguration config)
        {
        ...
        public async Task<IActionResult> Login(LoginDTO userFromConsumer)
        {
            if (ModelState.IsValid)
            {
                AplicationUser user = await userManager.FindByNameAsync(userFromConsumer.UserName);
                if (user != null)
                {
